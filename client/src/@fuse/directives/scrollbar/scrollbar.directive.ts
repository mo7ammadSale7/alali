...
export class FuseScrollbarDirective implements OnChanges, OnInit, OnDestroy {
    ...
    geometry(prefix: string = 'scroll'): ScrollbarGeometry {
        return new ScrollbarGeometry(
            this.dir === "ltr" ? this._elementRef.nativeElement[prefix + 'Left'] : this._elementRef.nativeElement[prefix + 'Right'],
    ...
    position(absolute: boolean = false): ScrollbarPosition {
        ...
        if (!absolute && this._ps) {
            ...
            scrollbarPosition = new ScrollbarPosition(
                this.dir === 'ltr' ? this._elementRef.nativeElement.scrollLeft : this._elementRef.nativeElement.scrollRight,
    ...
    scrollTo(x: number, y?: number, speed?: number): void {
        if (y == null && speed == null) {
            ...
            if (x != null) {
                this.dir === 'ltr' ? this.animateScrolling('scrollLeft', x, speed) : this.animateScrolling('scrollRight', x, speed);
            }
    ...
    scrollToLeft(offset: number = 0, speed?: number): void {
        ...
        this.dir === 'ltr' ? this.animateScrolling('scrollLeft', offset, speed) :
            this.animateScrolling('scrollRight', right - offset, speed);
    }
    ...
    scrollToRight(offset: number = 0, speed?: number): void {
        const left =
            this._elementRef.nativeElement.scrollWidth -
            this._elementRef.nativeElement.clientWidth;
        this.dir === 'rtl' ? this.animateScrolling('scrollRight', offset, speed) :
    ...
    scrollToElement(
        ...
        if (this._elementRef.nativeElement.classList.contains('ps--active-x')) {
            ...
            const currentPos = this.dir === 'ltr' ? this._elementRef.nativeElement['scrollLeft'] : this._elementRef.nativeElement['scrollRight'];
            const position = this.dir === 'ltr' ? elementPos.left - scrollerPos.left + currentPos : elementPos.right - scrollerPos.right + currentPos;
